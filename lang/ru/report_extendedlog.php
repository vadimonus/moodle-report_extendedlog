...
$string['filter_ip4_help'] = '<p>Укажите через запятую список полных или частичных IP-адресов.</p><p>Примеры:</p><ul><li>192.168.10.1</li><li>192.168.</li><li>231.3.56.10-20</li><li>192.168.10.1,192.168.,231.3.56.10-20</li></ul>';
...
$string['notificationhighload'] = '<div style="text-align: center; margin: 10px;">Внимание! Этот отчет использует не оптимизированные запросы к базе данных. Такие запросы могут выполняться очень долго и привести к большой нагрузке на сервер базы данных.<br/>Для ускорения запросов настоятельно рекомендуется указывать временной интервал для поиска событий.</div>';
